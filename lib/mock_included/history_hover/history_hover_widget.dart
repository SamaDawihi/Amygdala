...
import 'history_hover_model.dart';
export 'history_hover_model.dart';

class HistoryHoverWidget extends StatefulWidget {
  const HistoryHoverWidget({super.key});

  @override
  _HistoryHoverWidgetState createState() => _HistoryHoverWidgetState();
}

class _HistoryHoverWidgetState extends State<HistoryHoverWidget> {
  late HistoryHoverModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HistoryHoverModel());
