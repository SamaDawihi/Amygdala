                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        'Password reset link has been sended to your emaill.',
                                        style: TextStyle(
                                          color: FlutterFlowTheme.of(context)
                                              .primaryText,
                                        ),
                                        ...
                                        child: ConfirmationComponentWidget(
                                          ...
                                          confirmAction: () async {
                                            if (currentUserEmail ==
                                              ...
                                              if (_model.emailUnique != null) {
                                                await actions.sendVerlink(
                                                  currentUserEmail,
                                                );
                                                ...
                                                ScaffoldMessenger.of(context)
                                                  ...
                                                  SnackBar(
                                                    content: Text(
                                                      'the new email is aleready exists.',
                                                      style: TextStyle(
                                                        color:
                                                            FlutterFlowTheme.of(
                                                                    context)
